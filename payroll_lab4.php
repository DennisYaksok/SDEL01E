...
<style>
    ...
    <body>
        <?php
            ...
            $employee_no="2021-2-02002";
            $department="Department of Computer Engineering";
            $firstname="Dennis Christian";
            $mname="";
            $surname="Ingig";
            $civil_status="Single";
            $designation="Student";
            $qualified_dependents="ME";
            $paydate="October 02, 2023";
    ...
    <div class="container">
        <div class="page_border">
            <h1 class="text-center" style="padding-top:10px; padding-bottom:10px; fontweight:bold;">JAC's Payroll Application</h1>
            ...
            <div class="payrol_form_group1">
                <div style="float:left; width:50%;">
                    <div style="margin-left:100px; margin-top:10px;">
                        <img src="images/user.png" class="imgthumbnail" style="width:250px;" alt="user profile">
                    ...
                    <div>
                        ...
                        <button type="submit" name="search" class="btn btn-danger" style="padding:5px; width:100px; margin-left:200px;">Search &#128269</button>                        
                    </div>
                </div>
