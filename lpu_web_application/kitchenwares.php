...
<body style="background:black url(Images/Assets/pattern.webp);">
    <div class="d-flex">
        <div class="vh-100 sticky-top" style="width: 280px;">
            <h1 class="text-white fs-5 text-center my-5">Dennis' Choice Enterprise</h1>
            ...
            <main class="container border bg-white">
                ...
                <div class="">
                    ...
                    <div class="px-3">
                        <div class="btn-group d-flex justify-content-center align-items-center">
                            ...
                            <div class="mx-auto my-2">
                                <h1 class="text-center">Dennis' Choice store</h1>
                            </div>
                        </div>
                    </div>
                    <!-- cards -->
                    <div class="row mx-auto row-cols-5">
                        ...
                        for ($i = 1; $i < 21; $i++) {
                            $label = "Kitchenware $i";
                            $price = "$Kitchenwares_prices[$i]";
                            echo "
                            <div class='col' onclick='handleItems(\"$label\", \"$price\")' role='button'>
                                <div class='card mb-3 mx-3 ' style='max-width: 300px;'>
                                    <div class='row g-0'>
                                        <img src='Images/Kitchenwares/$i.jpg' class='card-img-top rounded-start' alt='...' height='100' style='width:100%;height:5.2vw;object-fit:contain'/>
